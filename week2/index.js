...
var l = "8";
// 請文字解釋為什麼
console.log(k * l > 21); //首先文字8會先轉換成數字8，所以相乘後左邊為24 > 21，所以為true
...
let customerName = BobPrice; //change this if use function in the future
let customerVIP = BobIsVip; //change this if use function in the future

if (customerName > giftPriceRule && customerVIP) {
...
if (
  ...
  console.log("玩家 A wins!");
} else {
  console.log("玩家 B wins!");
}
